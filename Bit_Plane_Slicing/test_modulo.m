...
b1 = modulo(d,2);
b2 = modulo(floor(d/2),2);
b3 = modulo(floor(d/4),2);
b4 = modulo(floor(d/8),2);
b5 = modulo(floor(d/16),2);
b6 = modulo(floor(d/32),2);
b7 = modulo(floor(d/64),2);
b8 = modulo(floor(d/128),2);
